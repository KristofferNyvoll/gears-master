var main = new (function () {
  ...
  this.toggleLanguageMenu = function (e) {
    if ($(".languageMenuDropDown").length == 0) {
      ...
      menuDropDown(self.$languageMenu, menuItems, {
  ...
  this.saveRobot = function () {
    ...
    hiddenElement.href =
      ...
      encodeURIComponent(JSON.stringify(robot.options, null, 2));
      ...
      let menuItems = [
        {
          ...
          line: false,
          callback: function () {
            self.openPage("https://github.com/QuirkyCort/gears/wiki");
          },
        },
        {
          html: "Github",
          line: false,
          callback: function () {
            self.openPage("https://github.com/QuirkyCort/gears");
          },
        },
        {
          html: "URL Generator",
        ...
        {
          html: i18n.get("#main-privacy#"),
          line: false,
          callback: function () {
            self.openPage("privacy.html");
          },
        },
        {
          html: i18n.get("#main-about#"),
          line: true,
          callback: self.openAbout,
        },
        {
          html: i18n.get("#main-display_fps#"),
          line: false,
          callback: simPanel.toggleFPS,
        },
      ];
      if (simPanel.showFPS) {
        menuItems[6].html =
          '<span class="tick">&#x2713;</span> ' + menuItems[6].html;
      }

      menuDropDown(self.$helpMenu, menuItems, {
        className: "helpMenuDropDown",
      });
    }
  };
  ...
  this.selectRobot = function () {
    ...
    let $description = $(
      '<div class="description"><img class="thumbnail" width="200" height="200"><div class="text"></div></div>'
    );
    ...
    function displayRobotDescriptions(robot) {
      ...
      if (robot.thumbnail) {
        ...
        $description
          .find(".thumbnail")
          .attr("src", "images/robots/default_thumbnail.png");
      }
    ...
    $select.change(function () {
      let robotTemplate = robotTemplates.find(
        (robotTemplate) => robotTemplate.name == $select.val()
      );
      displayRobotDescriptions(robotTemplate);
    });
    ...
    acknowledgeDialog({
      ...
      message: $(
        "<p>" +
          ...
          "</p>" +
          "<p>" +
          i18n.get("#main-rotation#") +
          ": " +
          rot +
          " " +
          i18n.get("#main-degrees#") +
          "</p>"
      ),
    });
  };
  ...
  this.toggleRobotMenu = function (e) {
    if ($(".robotMenuDropDown").length == 0) {
      ...
      let menuItems = [
        {
          html: i18n.get("#main-select_robot#"),
          line: false,
          callback: self.selectRobot,
        },
        {
          html: i18n.get("#main-robot_configurator#"),
          line: true,
          callback: self.configuratorWindow,
        },
        {
          html: i18n.get("#main-robot_load_file#"),
          line: false,
          callback: self.loadRobotLocal,
        },
        {
          html: i18n.get("#main-robot_save_file#"),
          line: true,
          callback: self.saveRobot,
        },
        {
          html: i18n.get("#main-display_position#"),
          line: false,
          callback: self.displayPosition,
        },
        {
          html: i18n.get("#main-save_position#"),
          line: false,
          callback: self.savePosition,
        },
        {
          html: i18n.get("#main-clear_position#"),
          line: false,
          callback: self.clearPosition,
        },
      ];

      menuDropDown(self.$robotMenu, menuItems, {
        className: "robotMenuDropDown",
      });
    }
  };
  ...
  this.toggleWorldsMenu = function (e) {
    if ($(".worldsMenuDropDown").length == 0) {
      ...
      let menuItems = [
        {
          html: i18n.get("#main-select_world#"),
          line: false,
          callback: simPanel.selectWorld,
        },
        {
          html: i18n.get("#main-world_builder#"),
          line: false,
          callback: self.worldBuilderWindow,
        },
        {
          html: i18n.get("#main-arena#"),
          line: true,
          callback: self.arenaWindow,
        },
        {
          html: i18n.get("#main-world_load_file#"),
          line: false,
          callback: simPanel.loadWorldLocal,
        },
        {
          html: i18n.get("#main-world_save_file#"),
          line: false,
          callback: simPanel.saveWorld,
        },
      ];

      menuDropDown(self.$worldsMenu, menuItems, {
        className: "worldsMenuDropDown",
      });
    }
  };
  ...
  this.togglePythonMenu = function (e) {
    if ($(".pythonMenuDropDown").length == 0) {
      ...
      menuItems[tickIndex].html =
        '<span class="tick">&#x2713;</span> ' + menuItems[tickIndex].html;

      menuDropDown(self.$pythonMenu, menuItems, {
        className: "pythonMenuDropDown",
      });
    }
  };
  ...
  this.toggleFileMenu = function (e) {
    if ($(".fileMenuDropDown").length == 0) {
      ...
      let menuItems = [
        {
          html: i18n.get("#main-new_program#"),
          line: true,
          callback: self.newProgram,
        },
        {
          html: i18n.get("#main-load_blocks#"),
          line: false,
          callback: self.loadFromComputer,
        },
        {
          html: i18n.get("#main-import_functions#"),
          line: false,
          callback: self.importFunctionsFromFile,
        },
        {
          html: i18n.get("#main-save_blocks#"),
          line: true,
          callback: self.saveToComputer,
        },
        {
          html: i18n.get("#main-load_python#"),
          line: false,
          callback: self.loadPythonFromComputer,
        },
        {
          html: i18n.get("#main-save_python#"),
          line: true,
          callback: self.savePythonToComputer,
        },
        {
          html: i18n.get("#main-export_zip#"),
          line: true,
          callback: self.saveZipToComputer,
        },
      ];

      menuDropDown(self.$fileMenu, menuItems, {
  ...
  this.saveToComputer = function () {
    ...
    hiddenElement.href =
      ...
      encodeURIComponent(blockly.getXmlText());
    hiddenElement.target = "_blank";
  ...
  this.savePythonToComputer = function () {
    ...
    var hiddenElement = document.createElement("a");
    hiddenElement.href =
      "data:text/x-python;charset=UTF-8," + encodeURIComponent(code);
    hiddenElement.target = "_blank";
  ...
  this.tabClicked = function (tabNav) {
    ...
    self.$panels
      .siblings('[aria-labelledby="' + match + '"]')
      .addClass("active");
